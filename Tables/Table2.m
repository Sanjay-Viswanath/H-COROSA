...
cd ..
fo = pwd;
fo1 = fullfile(pwd,'MRI_Data','Experiment_2');
fo2 = fullfile(pwd,'MAT_Files','Experiment_2');
cd Tables
...
for ind1 = 1:Ni
    ...
    for ind2 = 1:2
        ...
        if ind2 == 2
            fn3 = ['MRI_',num2str(ind1),'_Radial_SR_1_Sig_20'];
            load(fullfile(fo1,[fn3,'.mat']),'Im');
        else
            fn3 = ['MRI_',num2str(ind1),'_TSP_SR_1_Sig_20'];
            load(fullfile(fo1,[fn3,'.mat']),'Im');
        end
