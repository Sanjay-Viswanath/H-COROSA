...
lh_snr = Lambda_Table3(17,4); 
lh_ssim = Lambda_Table3(17,3); 
...
save(fullfile(fold_out,'T5_20per_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'T5_20per_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
