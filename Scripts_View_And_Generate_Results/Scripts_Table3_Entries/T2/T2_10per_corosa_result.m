...
load(fullfile(fold_in,'T2_10per.mat'),'Im'); 
% Load Measurement 
load(fullfile(fold_in,'T2_10per.mat'),'Imn','TF');
disp('T2_10per')
...
lc_snr = Lambda_Table3(6,2); 
lc_ssim = Lambda_Table3(6,1); 
...
save(fullfile(fold_out,'T2_10per_corosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'T2_10per_corosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
