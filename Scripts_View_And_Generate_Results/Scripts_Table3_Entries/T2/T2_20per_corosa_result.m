...
lc_snr = Lambda_Table3(6,4); 
lc_ssim = Lambda_Table3(6,3); 
...
save(fullfile(fold_out,'T2_20per_corosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'T2_20per_corosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
