...
lh_snr = Lambda_Table3(1,2); 
lh_ssim = Lambda_Table3(1,1); 
...
save(fullfile(fold_out,'T1_10per_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'T1_10per_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
