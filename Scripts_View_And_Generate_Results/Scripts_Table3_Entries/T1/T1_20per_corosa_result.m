...
load(fullfile(fold_in,'T1_20per.mat'),'Im'); 
% Load Measurement 
load(fullfile(fold_in,'T1_20per.mat'),'Imn','TF');
disp('T1_20per')
...
lc_snr = Lambda_Table3(2,4); 
lc_ssim = Lambda_Table3(2,3); 
...
save(fullfile(fold_out,'T1_20per_corosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'T1_20per_corosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
