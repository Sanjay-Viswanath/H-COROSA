...
load(fullfile(fold_in,'T1_10per.mat'),'Im'); 
% Load Measurement 
load(fullfile(fold_in,'T1_10per.mat'),'Imn','TF');
disp('T1_10per')
...
lc_snr = Lambda_Table3(2,2); 
lc_ssim = Lambda_Table3(2,1); 
...
save(fullfile(fold_out,'T1_10per_corosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'T1_10per_corosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
