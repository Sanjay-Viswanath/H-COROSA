...
load(fullfile(fold_in,'T4_20per.mat'),'Im'); 
% Load Measurement 
load(fullfile(fold_in,'T4_20per.mat'),'Imn','TF');
disp('T4_20per')
...
lc_snr = Lambda_Table3(14,4); 
lc_ssim = Lambda_Table3(14,3); 
...
save(fullfile(fold_out,'T4_20per_corosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'T4_20per_corosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
