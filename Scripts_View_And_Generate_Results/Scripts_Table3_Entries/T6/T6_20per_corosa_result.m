...
load(fullfile(fold_in,'T6_20per.mat'),'Im'); 
% Load Measurement 
load(fullfile(fold_in,'T6_20per.mat'),'Imn','TF');
disp('T6_20per')
...
lc_snr = Lambda_Table3(22,4); 
lc_ssim = Lambda_Table3(22,3); 
...
save(fullfile(fold_out,'T6_20per_corosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'T6_20per_corosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
