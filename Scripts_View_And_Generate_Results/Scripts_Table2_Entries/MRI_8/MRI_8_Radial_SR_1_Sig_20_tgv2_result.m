...
load(fullfile(fold_ref,'MRI_8.mat'),'Im'); 
% Load Measurement 
load(fullfile(fold_in,'MRI_8_Radial_SR_1_Sig_20.mat'),'Imn','TF');
disp('MRI_8_Radial_SR_1_Sig_20')
...
ltgv2_snr = Lambda_Table2(38,2); 
ltgv2_ssim = Lambda_Table2(38,1); 
...
Irec = X(:,:,1); 
save(fullfile(fold_out,'MRI_8_Radial_SR_1_Sig_20_tgv2_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_8_Radial_SR_1_Sig_20_tgv2_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:240,1:240); 
temp2 = Irec(1:240,1:240); 
