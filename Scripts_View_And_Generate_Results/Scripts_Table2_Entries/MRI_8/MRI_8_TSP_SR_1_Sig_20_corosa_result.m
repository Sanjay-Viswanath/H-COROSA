...
lc_snr = Lambda_Table2(37,4); 
lc_ssim = Lambda_Table2(37,3); 
...
save(fullfile(fold_out,'MRI_8_TSP_SR_1_Sig_20_corosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_8_TSP_SR_1_Sig_20_corosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:240,1:240); 
temp2 = Irec(1:240,1:240); 
