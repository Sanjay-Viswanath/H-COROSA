...
lh_snr = Lambda_Table2(26,4); 
lh_ssim = Lambda_Table2(26,3); 
...
save(fullfile(fold_out,'MRI_6_TSP_SR_1_Sig_20_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_6_TSP_SR_1_Sig_20_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:240,1:240); 
temp2 = Irec(1:240,1:240); 
