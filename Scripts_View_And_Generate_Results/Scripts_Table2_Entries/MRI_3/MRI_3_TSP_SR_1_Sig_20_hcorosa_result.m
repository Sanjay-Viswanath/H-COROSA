...
lh_snr = Lambda_Table2(11,4); 
lh_ssim = Lambda_Table2(11,3); 
...
save(fullfile(fold_out,'MRI_3_TSP_SR_1_Sig_20_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_3_TSP_SR_1_Sig_20_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
