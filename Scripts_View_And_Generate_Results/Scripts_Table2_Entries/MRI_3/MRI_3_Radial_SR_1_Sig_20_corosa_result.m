...
lc_snr = Lambda_Table2(12,2); 
lc_ssim = Lambda_Table2(12,1); 
...
save(fullfile(fold_out,'MRI_3_Radial_SR_1_Sig_20_corosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_3_Radial_SR_1_Sig_20_corosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
