...
ltgv2_snr = Lambda_Table2(43,2); 
ltgv2_ssim = Lambda_Table2(43,1); 
...
Irec = X(:,:,1); 
save(fullfile(fold_out,'MRI_9_Radial_SR_1_Sig_20_tgv2_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_9_Radial_SR_1_Sig_20_tgv2_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:240,1:240); 
temp2 = Irec(1:240,1:240); 
