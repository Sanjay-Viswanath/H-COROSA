...
load(fullfile(fold_ref,'MRI_7.mat'),'Im'); 
% Load Measurement 
load(fullfile(fold_in,'MRI_7_Radial_SR_1_Sig_20.mat'),'Imn','TF');
disp('MRI_7_Radial_SR_1_Sig_20')
...
lh_snr = Lambda_Table2(31,2); 
lh_ssim = Lambda_Table2(31,1); 
...
save(fullfile(fold_out,'MRI_7_Radial_SR_1_Sig_20_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
temp1 = Im(1:480,1:480); 
temp2 = Irec(1:480,1:480); 
...
save(fullfile(fold_out,'MRI_7_Radial_SR_1_Sig_20_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:480,1:480); 
temp2 = Irec(1:480,1:480); 
