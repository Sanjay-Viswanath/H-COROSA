...
lhs_snr = Lambda_Table2(35,2); 
lhs_ssim = Lambda_Table2(35,1); 
...
save(fullfile(fold_out,'MRI_7_Radial_SR_1_Sig_20_hs_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_7_Radial_SR_1_Sig_20_hs_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:480,1:480); 
temp2 = Irec(1:480,1:480); 
