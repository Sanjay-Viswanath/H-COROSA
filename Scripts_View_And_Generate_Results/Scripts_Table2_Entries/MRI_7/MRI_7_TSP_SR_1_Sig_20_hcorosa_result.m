...
% Load Measurement 
load(fullfile(fold_in,'MRI_7_TSP_SR_1_Sig_20.mat'),'Imn','TF');
disp('MRI_7_TSP_SR_1_Sig_20')
...
lh_snr = Lambda_Table2(31,4); 
lh_ssim = Lambda_Table2(31,3); 
...
save(fullfile(fold_out,'MRI_7_TSP_SR_1_Sig_20_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_7_TSP_SR_1_Sig_20_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:480,1:480); 
temp2 = Irec(1:480,1:480); 
