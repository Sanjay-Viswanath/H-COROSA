...
lhs_snr = Lambda_Table2(10,2); 
lhs_ssim = Lambda_Table2(10,1); 
...
save(fullfile(fold_out,'MRI_2_Radial_SR_1_Sig_20_hs_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_2_Radial_SR_1_Sig_20_hs_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:512,1:512); 
temp2 = Irec(1:512,1:512); 
