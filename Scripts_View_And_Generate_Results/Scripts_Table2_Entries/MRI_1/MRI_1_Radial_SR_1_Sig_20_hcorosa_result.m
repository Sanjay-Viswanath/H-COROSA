...
lh_snr = Lambda_Table2(1,2); 
lh_ssim = Lambda_Table2(1,1); 
...
save(fullfile(fold_out,'MRI_1_Radial_SR_1_Sig_20_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_1_Radial_SR_1_Sig_20_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:512,1:512); 
temp2 = Irec(1:512,1:512); 
