...
ltgv2_snr = Lambda_Table2(18,4); 
ltgv2_ssim = Lambda_Table2(18,3); 
...
Irec = X(:,:,1); 
save(fullfile(fold_out,'MRI_4_TSP_SR_1_Sig_20_tgv2_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_4_TSP_SR_1_Sig_20_tgv2_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
