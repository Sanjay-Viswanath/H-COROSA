...
% Load Measurement 
load(fullfile(fold_in,'MRI_4_TSP_SR_1_Sig_20.mat'),'Imn','TF');
disp('MRI_4_TSP_SR_1_Sig_20')
...
lh_snr = Lambda_Table2(16,4); 
lh_ssim = Lambda_Table2(16,3); 
...
save(fullfile(fold_out,'MRI_4_TSP_SR_1_Sig_20_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_4_TSP_SR_1_Sig_20_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
