...
load(fullfile(fold_in,'MRI_10_Spiral_SR_2_var_15.mat'),'Im'); 
% Load Measurement 
load(fullfile(fold_in,'MRI_10_Spiral_SR_2_var_15.mat'),'Imn','TF');
disp('MRI_10_Spiral_SR_2_var_15')
...
lh_snr = Lambda_Table4(22,2); 
lh_ssim = Lambda_Table4(22,1); 
...
save(fullfile(fold_out,'MRI_10_Spiral_SR_2_var_15_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_10_Spiral_SR_2_var_15_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:240,1:240); 
temp2 = Irec(1:240,1:240); 
