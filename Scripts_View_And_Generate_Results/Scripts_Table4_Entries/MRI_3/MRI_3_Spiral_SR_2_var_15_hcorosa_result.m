...
load(fullfile(fold_in,'MRI_3_Spiral_SR_2_var_15.mat'),'Im'); 
% Load Measurement 
load(fullfile(fold_in,'MRI_3_Spiral_SR_2_var_15.mat'),'Imn','TF');
disp('MRI_3_Spiral_SR_2_var_15')
...
lh_snr = Lambda_Table4(10,2); 
lh_ssim = Lambda_Table4(10,1); 
...
save(fullfile(fold_out,'MRI_3_Spiral_SR_2_var_15_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_3_Spiral_SR_2_var_15_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
