...
if exist(fr,'file') && Chk_Run==0
    ...
    cd MRI_3
    save('temp_store.mat');
    MRI_3_Spiral_SR_2_Sig_20_hcorosa_result
    load('temp_store.mat');
...
if exist(fr,'file') && Chk_Run==0
    ...
    cd MRI_3
    save('temp_store.mat');
    MRI_3_Spiral_SR_2_Sig_20_corosa_result
    load('temp_store.mat');
    delete temp_store.mat
    cd ..
    cd ..
...
if exist(fr,'file') && Chk_Run==0
    ...
    cd MRI_3
    save('temp_store.mat');
    MRI_3_Spiral_SR_2_Sig_20_hs_result
    load('temp_store.mat');
    delete temp_store.mat
    cd ..
    cd ..
...
Fig1 = figure('Name',['Fig.11.Reconstruction of I3 from 20% spiral samples:'...
...
Fig2 = figure('Name',['Fig.11.Reconstruction of I3 from 20% spiral samples:'...
...
Fig3 = figure('Name','Fig.11.Reconstruction of I3 from 20% spiral samples: (a) Original I3 with selected region',...
    'NumberTitle','off');
imshow(Im,[]);
