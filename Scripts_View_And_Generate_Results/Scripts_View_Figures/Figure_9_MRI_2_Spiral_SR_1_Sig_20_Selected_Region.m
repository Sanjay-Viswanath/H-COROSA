...
if exist(fr,'file') && Chk_Run==0
    ...
    cd MRI_2
    save('temp_store.mat');
    MRI_2_Spiral_SR_1_Sig_20_hcorosa_result
    load('temp_store.mat');
...
if exist(fr,'file') && Chk_Run==0
    ...
    cd MRI_2
    save('temp_store.mat');
    MRI_2_Spiral_SR_1_Sig_20_corosa_result
    load('temp_store.mat');
    delete temp_store.mat
    cd ..
    cd ..
...
if exist(fr,'file') && Chk_Run==0
    ...
    cd MRI_2
    save('temp_store.mat');
    MRI_2_Spiral_SR_1_Sig_20_hs_result
    load('temp_store.mat');
    delete temp_store.mat
    cd ..
    cd ..
...
Fig1 = figure('Name',['Fig.9.Reconstruction of I2 from 10% spiral samples:'...
...
Fig2 = figure('Name',['Fig.9.Reconstruction of I2 from 10% spiral samples:'...
...
Fig3 = figure('Name','Fig.9.Reconstruction of I2 from 10% spiral samples: (a) Original I2 with selected region',...
    'NumberTitle','off');
imshow(Im,[]);
