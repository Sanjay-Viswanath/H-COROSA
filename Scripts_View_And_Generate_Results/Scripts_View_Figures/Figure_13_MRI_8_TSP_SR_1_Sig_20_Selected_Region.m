...
fi1 = fullfile(fi,'Models_and_Measurements','Measurements_for_Table2');
fi2 = fullfile(fi,'Generated_Reconstruction_Results','Reconstructions_in_Table2');
...
Fig1 = figure('Name',['Fig.13.Reconstruction of I8 from 12% TSP samples:'...
...
Fig2 = figure('Name',['Fig.13.Reconstruction of I8 from 12% TSP samples:'...
...
Fig3 = figure('Name','Fig.11.Reconstruction of I8 from 12% TSP samples: (a) Original I8 with selected region',...
    'NumberTitle','off');
