...
% Load Measurement 
load(fullfile(fold_in,'MRI_1_Spiral_SR_1_Sig_20.mat'),'Imn','TF');
disp('MRI_1_Spiral_SR_1_Sig_20')
...
lh_snr = Lambda_Table1(1,2); 
lh_ssim = Lambda_Table1(1,1); 
...
save(fullfile(fold_out,'MRI_1_Spiral_SR_1_Sig_20_hcorosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_1_Spiral_SR_1_Sig_20_hcorosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:512,1:512); 
temp2 = Irec(1:512,1:512); 
