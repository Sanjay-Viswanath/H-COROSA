...
lc_snr = Lambda_Table1(2,4); 
lc_ssim = Lambda_Table1(2,3); 
...
save(fullfile(fold_out,'MRI_1_Spiral_SR_2_Sig_20_corosa_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_1_Spiral_SR_2_Sig_20_corosa_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:512,1:512); 
temp2 = Irec(1:512,1:512); 
