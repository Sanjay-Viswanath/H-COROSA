...
ltgv2_snr = Lambda_Table1(8,4); 
ltgv2_ssim = Lambda_Table1(8,3); 
...
Irec = X(:,:,1); 
save(fullfile(fold_out,'MRI_2_Spiral_SR_2_Sig_20_tgv2_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_2_Spiral_SR_2_Sig_20_tgv2_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:512,1:512); 
temp2 = Irec(1:512,1:512); 
