...
lhs_snr = Lambda_Table1(45,2); 
lhs_ssim = Lambda_Table1(45,1); 
...
save(fullfile(fold_out,'MRI_9_Spiral_SR_1_Sig_20_hs_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_9_Spiral_SR_1_Sig_20_hs_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:240,1:240); 
temp2 = Irec(1:240,1:240); 
