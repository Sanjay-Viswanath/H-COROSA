...
lhs_snr = Lambda_Table1(15,4); 
lhs_ssim = Lambda_Table1(15,3); 
...
save(fullfile(fold_out,'MRI_3_Spiral_SR_2_Sig_20_hs_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_3_Spiral_SR_2_Sig_20_hs_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:256,1:256); 
temp2 = Irec(1:256,1:256); 
