...
ltv2_snr = Lambda_Table1(29,2); 
ltv2_ssim = Lambda_Table1(29,1); 
...
save(fullfile(fold_out,'MRI_6_Spiral_SR_1_Sig_20_tv2_best_snr.mat'),'Irec','lam'); 
% Compute SNR 
...
save(fullfile(fold_out,'MRI_6_Spiral_SR_1_Sig_20_tv2_best_ssim.mat'),'Irec','lam'); 
% Compute SSIM 
temp1 = Im(1:240,1:240); 
temp2 = Irec(1:240,1:240); 
